...
<body>
    ...
    ?>
    <form action="../controller/cadastrarNotaController.php" method="POST">
        ...
        <tbody>
            <tr>
                ...
                <td>
                    <div class="row">
                        <div class="col">
                            <input type="text" class="form-control" placeholder="Nota" name="nota1[<?=$cont?>]">
                        </div>
                    </div>
                </td>
                <td>
                    <div class="row">
                        <div class="col">
                            <input type="text" class="form-control" placeholder="Nota" name="nota2[<?=$cont?>]">
                        </div>
                    </div>
                </td>
            </tr>         
